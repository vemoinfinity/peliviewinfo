    ...
    <div>
      ...
      <nav className=' bg-gray-500 flex my-4 mx-10 lg:mx-52 justify-between items-center rounded-lg' >
        ...
        <button onClick={handleIncreasePage}>
          <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-arrow-badge-right" width="36" height="36" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#ff2825" fill="none" strokeLinecap="round" strokeLinejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
