...
const HomePage = () => {
  ...
  const { movies, loading, error,isLoading } = useMovieList(
  ...
  return (
    <div className='font-medium'>
      <div className=' text-5xl flex  my-6 justify-center  rounded-lg'>Películas Populares</div>     
      <nav className=' bg-gray-500 flex my-4 mx-10 lg:mx-52 justify-between items-center rounded-lg' >
        <button className='hover:bg-gray-300 rounded-lg' onClick={handleDecreasePage} disabled={isPrevButtonDisabled}>
          <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-arrow-badge-left" width="40" height="50" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ff2825" fill="none" stroke-linecap="round" stroke-linejoin="round">
        ...
        <button className=' hover:bg-gray-300 rounded-lg' onClick={handleIncreasePage}>
          <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-arrow-badge-right" width="40" height="50" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ff2825" fill="none" stroke-linecap="round" stroke-linejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
